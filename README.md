<h1 align="center">Siddharth Nair</h1>
...
- **C++ Software:** Architecting and implementing complex, multi-threaded applications using modern C++23, with a current focus on developing a physically-based renderer (Indus) based on [PBRT.org](https://PBRT.org).
